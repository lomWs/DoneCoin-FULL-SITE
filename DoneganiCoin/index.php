...
<body>
        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-dark p-md-3">
            <div class="container">
              <a class="navbar-brand" href="#"><img src="./img/DoneganiCoin.png" width="100" height="100" class="d-inline-block align-text-top" ></a>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item ">
                    <a class="nav-link text-secondary" href="index.php"><i class="fa-solid fa-house"></i> Home</a>
                    </li>
                    <li class="nav-item">
    ...
    <!-- Banner Image  -->
      ...
      <div class="content text-center">
        ...
        -webkit-text-stroke: 2px rgb(255, 255, 255)"><strong>DoneganiCoin NETWORK</strong> </h1>

        <h4 class="text-white" style=" font-family:sans-serif; ">La nuova frontiera della blockchain.</em></h4>
        <br>
        <h3 class="text-white" style=" font-family:sans-serif; ">Donecoin è una crypto valuta sviluppata in php che semplifica i pagamenti</h3>
        <h3 class="text-white" style=" font-family:sans-serif; "> con un interfaccia user-friendly e server efficienti </h3>
      
        <h5 class="text-white"><em>Powered by Roberto Scandale</em></h5>
      </div>
